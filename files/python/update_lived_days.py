...
def update_lived_days(all_settings, mode):
    ...
    all_executions = sqlite_command(all_settings, SQL_TO_LIST_LIVED_DAYS_UPDATE)[1]
    today = False
    ...
    if not today:
        ...
        all_date_times = sqlite_command(all_settings, SQL_TO_LIST_ALL_DATE_GROUPS)[1]
        date_dict = {}
        ...
        for date_only in date_dict:
            ...
            for ioc_lived_days in date_dict[date_only]:
                ...
                sqlite_command(all_settings, SQL_TO_UPDATE_LIVED_DAYS_OF_IOCS, (new, date_only, ioc_lived_days))
        ...
        sqlite_command(all_settings, SQL_TO_ADD_LIVED_DAYS_HISTORY, (now_date_time_format, ))
